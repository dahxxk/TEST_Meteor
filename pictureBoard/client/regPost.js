...
Template.regPost.onCreated(function () {
    ...
    var instance = this;
    instance.resetWriteForm = function(){
        $(instance.findAll(".modal=dialog")).hide();
        $(instance.findAll("input[type=text]")).val("");
        $(instance.findAll("input[name=file-upload]")).val("");
        $(instance.editor.elements[0]).html("");
        instance.tempImage.set("");
    }
